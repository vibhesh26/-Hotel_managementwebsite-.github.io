...
$result=mysqli_query($con,"select logid, passward, createdBy, createdDate, lastupdate from loginmast") ;
echo "<center><table class='reportTable' border='1px'> </center>
<h3> <center><font color=red>Login Master Info</font></CENTER></h3>
<tr class='myThTr'>
<th>Log ID</th> 
<th>Password</th> 
<th>CreatedBy</th>
